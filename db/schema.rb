...
ActiveRecord::Schema.define(version: 20150526214459) do
  ...
  add_index "alcohols", ["slug"], name: "index_alcohols_on_slug", unique: true
  ...
  add_index "cocktails", ["slug"], name: "index_cocktails_on_slug", unique: true
